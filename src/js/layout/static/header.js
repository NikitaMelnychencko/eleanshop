...
//     брюки: 'pants',
//     платья: 'dresses',
//     'топы и жилеты': 'tops-and-vests',
//     'осень-зима 20-21': 'autumn-winter',
//     'вечерние комплекты': 'evening-sets',
//     предзаказ: 'preorder',
//     'свадьба и выпускной': 'wedding-and-graduation',
//     доставка: 'delivery',
//     акции: 'promotions',
//     возврат: 'return',
//     'размерная таблица': 'size-сhart',
//     примерка: 'fitting',
//     'оптовым покупателям': 'for-wholesale-buyers',
//     шоурум: 'showroom',
//     отзывы: 'reviews',
//     статьи: 'articles',
//     блог: 'blog',
