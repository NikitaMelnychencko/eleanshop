...
[...formFittingInShowroom.formInputs, ...formFittingInShowroom.formTextarea].forEach(elemForm => {
...
formFittingInShowroom.form.forEach(elem => {
...
//============see to block size
formFittingInShowroom.box.forEach(elem => {
